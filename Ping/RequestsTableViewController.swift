...
//started by replacing 'todo' with 'requests'
...
class RequestsTableViewController: UITableViewController, RequestsDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.table = client.tableWithName("Requests")!
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject!)
    {
        if segue.identifier == "addItem" {
            let requestsController = segue.destinationViewController as RequestsViewController
